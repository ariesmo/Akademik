							...
							<div class="panel panel-default">
								<div class="panel-heading">
									...
									<div class="panel-tools">
										...
										<?= anchor('ruangan/add', '<i class="fa fa-pencil-square-o" title="Tambah"></i>','class="btn btn-xs btn-link"');?>
										<?= anchor('ruangan', '<i class="fa fa-refresh" title="Refresh"></i>','class="btn btn-xs btn-link panel-refresh"');?>
