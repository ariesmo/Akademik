						<div class="col-sm-4">
							<div class="core-box">
								<div class="heading">
									<!--<span class="fa-layers fa-fw" data-fa-transform="down-10" style="background:MistyRose">
									<i class="fas fa-circle fa-5x" style="color:Tomato"></i>
									<i class="fas fa-user-tie fa-rotate-180 " data-fa-transform="shrink-50 up-5 right-28"></i>
									</span>-->
									<i class="fas fa-user-tie circle-icon circle-green"></i>
										<h2>Manage Users</h2>
								...
								<a class="view-more" href="#">
									View More <i class="fas fa-arrow-alt-circle-right"></i>
								</a>
							</div>
						</div>
						<div class="col-sm-4">
							<div class="core-box">
								<div class="heading">
									<i class="fas fa-paperclip circle-icon circle-teal"></i>
									<h2>Manage Orders</h2>
								</div>
								<div class="content">
									Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.
						...
						<div class="col-sm-4">
							<div class="core-box">
								<div class="heading">
									<i class="fas fa-database circle-icon circle-bricky"></i>
									<h2>Manage Data</h2>
								</div>
								<div class="content">
									Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.
							...
							<div class="panel panel-default">
								...
								<div class="panel-body panel-scroll" style="height:300px">
									<table class="table table-striped table-hover" id="sample-table-1">
										...
										<tbody>
											<tr>
												<td class="center"><img src="<?= base_url();?>/assets/images/avatar-1.jpg" alt="image"/></td>
												<td>Peter Clark</td>
												<td class="hidden-xs">
											...
											<tr>
												<td class="center"><img src="<?= base_url();?>/assets/images/avatar-2.jpg" alt="image"/></td>
												<td>Nicole Bell</td>
												<td class="hidden-xs">
												<a href="#" rel="nofollow" target="_blank">
													nicole@example.com
											...
											<tr>
												<td class="center"><img src="<?= base_url();?>/assets/images/avatar-3.jpg" alt="image"/></td>
											...
											<tr>
												<td class="center"><img src="<?= base_url();?>/assets/images/avatar-5.jpg" alt="image"/></td>
												<td>Kenneth Ross</td>
												<td class="hidden-xs">
												<a href="#" rel="nofollow" target="_blank">
													kenneth@example.com
											...
											<tr>
												<td class="center"><img src="<?= base_url();?>/assets/images/avatar-4.jpg" alt="image"/></td>
									...
									<div class="panel panel-default">
										...
										<div class="panel-body panel-scroll" style="height:460px">
											<ol class="discussion">
												<li class="other">
													<div class="avatar">
														<img alt="" src="<?= base_url();?>/assets/images/avatar-4.jpg">
													</div>
													<div class="messages">
														<p>
															Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.
