							...
							<div class="panel-body">
										<table class="table table-striped table-bordered table-hover table-full-width dataTable" cellspacing="0" width="100%">
							                <thead>
							                    ...
							                    <tr>
							                        <td>JURUSAN</td>
							                        <td>Kelas <?= $rombel['kelas'].' '.$rombel['jurusan'];?> (<?php echo $nis['nama_rombel'];?>) </td>
							                    </tr>
							                </thead>
							            </table>
							</div>
							                ...
							                <thead>
							                    <tr>
							                        ...
							                        <td align="center">NAMA</td>
							                     	<td align="center">LIHAT NILAI</td>
							                    </tr>
							                </thead>
							                <tbody>
							                	<?php
							                	foreach($siswa->result() as $row){
							                		echo "<tr>
									                        ...
									                        <td align='center'>$row->nama</td>
									                     	<td align='center'>".anchor('raport/nilai_semester/'.$row->nim, 'Lihat Raport', 'class="btn btn-success bt-sm"')."</td>
									                    </tr>";
							                	}
